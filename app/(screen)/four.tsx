...
const Template4: React.FC = () => {
  ...
  // Kita custom content di dalam ScrollView untuk menempatkan selector di atasnya
  // dan TemplateDual di bawahnya
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        {/* Template Dual component - simpan dalam View untuk positioning */}
        <View style={styles.templateContainer}>
          <TemplateDual
            aspectRatio={getAspectRatio(selectedRatio)}
            title={`Template Dual (${selectedRatio})`}
